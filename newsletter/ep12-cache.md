...
* “간이과세자로 할까, 일반과세자로 할까” → 매출만 보면 간이가 단순하다(2024년 7월부터 간이과세 기준이 연매출 8천만 원에서 1억 400만 원 미만으로 상향됐다). 하지만 앱 개발자는 다르다. 애플·구글 해외 매출은 부가세 영세율(0%)이 적용돼서, 일반과세자면 장비·사무용품 등에 낸 매입 부가세를 환급받을 수 있는데 간이과세자는 환급이 안 된다. 그래서 수출(해외) 매출 비중이 큰 앱 개발자라면 오히려 일반과세자가 유리할 수 있다. (나도 처음엔 간이로 신청했다가 일반으로 다시 바꿨다.)
* “부가세 신고는?” → 간이과세자는 1년에 1회 (1월)
* “앱 수익은 어디서 신고?” → 종합소득세 (5월)

_세무 기준 출처: 간이과세 기준 1억 400만 원 상향은 [기획재정부 정책브리핑](https://www.korea.kr/news/policyNewsView.do?newsId=148926953), 해외매출 영세율·매입세액 환급은 [앱스토어 개발자 세금 가이드](https://ijemin.com/blog/%EC%95%B1%EC%8A%A4%ED%86%A0%EC%96%B4-%EA%B0%9C%EB%B0%9C%EC%9E%90-%EC%84%B8%EA%B8%88-%EA%B0%80%EC%9D%B4%EB%93%9C-%EB%B6%80%EA%B0%80%EC%84%B8-1/) 참고. 본인 상황에 따라 다르니 세무사 상담을 권한다._

...
변경점: 5막 + 메타 + 코다 = 옵션 X 결말로 재작성. 원본은 "맥미니 셋업+일주일 운영 후 보강" 으로 끝맺음 보류 상태였는데, 그 사이(2026-04-27) v4 옵션 X 결정으로 맥미니마저 plist 안 들이기로 확정 → 빼기가 두 번 일어난 진짜 결말이 들어옴.
...
> 🖼 IMAGE 1 (Hero) — "쿠팡 라파5 8GB 28만원 화면" 과 "본가 거실 한쪽에 놓인 M1 맥미니" 두 컷을 좌→우 화살표로 연결. 그 옆에 "→ 그리고 그것마저 들이지 않았다" 작은 글씨 첨언. 1200×630px.
...
4. **"이미 들인 것도 use case 가 안 맞으면 빼자."** — 5막의 가장 어려운 단계. 데스크탑·노트북·trend-curator 까지 세 가지를 같이 동결/제거했다. 매몰비용을 인정하는 게 처음엔 손해처럼 느껴지지만, 거기서 더 운영 비용을 쌓는 게 진짜 손해다.

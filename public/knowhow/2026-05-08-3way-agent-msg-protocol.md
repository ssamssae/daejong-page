...
case "$TO_NORM" in
  macbook|mac|본진)
    ...
    SEND_CHAT="${TELEGRAM_CHAT_ID_MACBOOK:-${TELEGRAM_CHAT_ID:-<CHAT_ID>}}"
    ;;
  wsl)
    SEND_TOKEN="${TELEGRAM_BOT_TOKEN_WSL:-}"
    SEND_CHAT="${TELEGRAM_CHAT_ID_WSL:-${TELEGRAM_CHAT_ID:-<CHAT_ID>}}"
    ;;
  macmini|mini)
    SEND_TOKEN="${TELEGRAM_BOT_TOKEN_MACMINI:-}"
    SEND_CHAT="${TELEGRAM_CHAT_ID_MACMINI:-${TELEGRAM_CHAT_ID:-<CHAT_ID>}}"
    ;;
...
TELEGRAM_CHAT_ID=<CHAT_ID>          # 사용자 Telegram ID (공통)
```

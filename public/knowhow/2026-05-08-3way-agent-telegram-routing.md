...
**공통 (3개 named 토큰 필수):**
```
TELEGRAM_BOT_TOKEN_MACBOOK=<TELEGRAM_BOT_TOKEN>
TELEGRAM_BOT_TOKEN_WSL=<TELEGRAM_BOT_TOKEN>
TELEGRAM_BOT_TOKEN_MACMINI=<TELEGRAM_BOT_TOKEN>
TELEGRAM_CHAT_ID=<CHAT_ID>
```

**각 기기마다 자기 봇을 BOT_TOKEN으로:**
- 맥북: `TELEGRAM_BOT_TOKEN=<TELEGRAM_BOT_TOKEN>` + `TELEGRAM_PEER_BOT_TOKEN=<TELEGRAM_BOT_TOKEN>`
- WSL: `TELEGRAM_BOT_TOKEN=<TELEGRAM_BOT_TOKEN>` + `TELEGRAM_PEER_BOT_TOKEN=<TELEGRAM_BOT_TOKEN>`
- 맥미니: `TELEGRAM_BOT_TOKEN=<TELEGRAM_BOT_TOKEN>` + `TELEGRAM_PEER_BOT_TOKEN=<TELEGRAM_BOT_TOKEN>`

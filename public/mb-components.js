/*
 * 마이너스베타스튜디오 공통 헤더/푸터 — work.kangdaejong.com 로컬 미러
 * Cloudflare 배포 인증이 막힌 동안 work 사이트가 stale 공통 헤더에 묶이지 않도록
 * kangdaejong-com/public/mb-components.js의 최신본을 로컬 배포물에 함께 싣습니다.
 *
 * 사용법:
 *   <script src="/mb-components.js" defer></script>

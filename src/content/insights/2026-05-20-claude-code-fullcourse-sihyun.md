...
- **사스포칼립스(직접 만들어 쓰기)**: daejong-page / choso 대시보드 / 약먹자·[메모요](https://play.google.com/store/apps/details?id=com.daejongkang.simple_memo_app) ([App Store](https://apps.apple.com/kr/app/id6762068073)) 등 — 이미 SaaS 대체 자체 제작 중.

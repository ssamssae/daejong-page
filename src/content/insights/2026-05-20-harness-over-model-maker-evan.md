...
2. **③ 도메인별 폴더 + 폴더 전용 규칙 md**: 형님 Flutter 앱들은 아직 파일 종류(screen/widget/util)로 묶임. 신규 기능부터 도메인(약 알림 / 결제 / 동기화)별로 묶고 폴더에 규칙 문서를 두면 AI 작업 범위가 그 폴더로 좁아져 컨텍스트가 깨끗해지고 도메인 일관성 유지. **[메모요](https://play.google.com/store/apps/details?id=com.daejongkang.simple_memo_app) ([App Store](https://apps.apple.com/kr/app/id6762068073)) 1.0.7 작업에 시범 적용 가치.**

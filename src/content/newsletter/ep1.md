---
title: "바이브코딩 뉴스레터 Ep.1 — 3시간 만에 나만의 로컬 AI 어시스턴트 만들기"
date: "2026-04-20"
version: "ep1"
---
...
다음 에피소드는 Phase 3 하면서 부딪힌 구조적 결정들 — 특히 "내 것은 기억하고 친구 것은 안 보는" 필터 설계 — 를 다루려 한다.
...
*다음 에피소드는 Phase 3 와 "친구에게 이 봇을 보여주기 전에 제외해야 하는 것들" 이야기.*

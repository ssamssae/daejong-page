...
- Playwright MCP 가 `https://minusbetastudio.substack.com/publish/post?type=newsletter` 진입
...
- 공개 URL `https://minusbetastudio.substack.com/p/<slug>` 진입해서 article DOM 의 h2/strong/blockquote/ul/li/pre/code 카운트로 검증
...
Ep.5 — **돌리기 (return-to-queue): 거절을 큐에서 다시 돌리는 법** — 은 사실 이 글보다 먼저 발행됐다 ([minusbetastudio.substack.com/p/32b](https://minusbetastudio.substack.com/p/32b)). 한줄일기 1.0 iOS 가 4월 29일 거절을 받고 4월 30일 ASC API 4단계 우회로 큐를 다시 돌렸더니 2시간 23분 만에 승인 메일이 도착한 이야기. 글감의 신선도가 발행 순서를 한 번 역전시켰다.

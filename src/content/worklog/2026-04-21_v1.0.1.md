---
title: "2026.04.21 작업일지 v1.0.1"
date: "2026-04-21"
version: "1.0.1"
---

> v1.0.0 이후 오전 구간. [메모요](https://play.google.com/store/apps/details?id=com.daejongkang.simple_memo_app) ([App Store](https://apps.apple.com/kr/app/id6762068073)) App Store 1.0.2 수동 출시 → 1.0.4 재업로드·심사 제출 → 신규 앱(약먹자/더치페이) 스크린샷 자동화 시도·실패 → /worklog 스킬 뉴스레터 스타일 전환.
...
- 1.0.4 (build 21): 어제 밤에 ipa 만들어둔 상태(`~/submit-queue/memoyo-1.0.4-21.ipa`, 19.4MB). altool CLI 로 업로드:
  ```
  xcrun altool --upload-app -f memoyo-1.0.4-21.ipa -t ios
  ```
  (인증 인자는 생략했다 — Apple ID 와 앱 전용 비밀번호는 로컬 시크릿에서 읽는다.)

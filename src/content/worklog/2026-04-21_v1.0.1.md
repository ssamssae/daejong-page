...
> v1.0.0 이후 오전 구간. [메모요](https://play.google.com/store/apps/details?id=com.daejongkang.simple_memo_app) App Store 1.0.2 수동 출시 → 1.0.4 재업로드·심사 제출 → 신규 앱(약먹자/더치페이) 스크린샷 자동화 시도·실패 → /worklog 스킬 뉴스레터 스타일 전환.

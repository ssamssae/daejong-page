...
> [한줄일기](https://play.google.com/store/apps/details?id=com.daejongkang.hanjul) 1.0 iOS App Store LIVE 확정. 동시에 Mac mini SoT 자동배포 Phase B 풀그린, 단어요 부트스트랩 진입.
...
- ASC 모바일 앱: 한줄일기 1.0 옆 초록 체크 ✓ ([메모요](https://play.google.com/store/apps/details?id=com.daejongkang.simple_memo_app) 1.0.4, 약먹자 1.0.1, 더치페이 1.0.2 와 동일 상태)

...
> 한 줄 요약: [한줄일기](https://play.google.com/store/apps/details?id=com.daejongkang.hanjul) 1.0 LIVE 다음 날 — Plan C 풀그린 + naver-blog v1 첫 발행 + 단어요 step 3b-4 + someday batch 23개 6그룹 분류 후 9건 closure.
...
- daejong-page 30건: portfolio 카드 정렬 + hover + hero / 뉴스레터 Ep.4 발행 + Ep.5 소급 / parking-lot 분리 (할일 4탭 → 3탭) / privacy-hankeup.html 추가 / [메모요](https://play.google.com/store/apps/details?id=com.daejongkang.simple_memo_app) status 정정 + 이메일 구독 버튼 Substack URL 교체 / someday batch + todos auto-sync.

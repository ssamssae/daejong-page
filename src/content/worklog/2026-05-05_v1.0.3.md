---
title: "2026.05.05 작업일지 v1.0.3"
date: "2026-05-05"
version: "1.0.3"
---

> v1.0.2 이후 추가 — 오전 parallel-cycle 4앱 누락 보강 + dutch_pay AdMob + rail-booking-sniff 고속철도 예매 자동화 v1 (23:00 KST)

## 추가 내용 (v1.0.2 이후, 및 v1.0.0 누락 보강)

---

## 자정 직후 — newsletter Ep.7 초안
...
## rail-booking-sniff 고도화 — PR #25/#26 + 고속철도 예매 자동화 v1

### 22:24 KST — PR #25: Mac 호환 IP 검출 개선

`fix(rail-booking-sniff): Mac 호환 IP 검출 + mitmproxy PATH 자동탐지 + booking-target.json (#25)`
...
### 23:00 KST — rail-booking-sniff 고속철도 예매 자동화 v1 완성

`feat(rail-booking-sniff): 고속철도 예매 자동화 v1`

mitmproxy로 스니핑한 철도 예매 API 엔드포인트를 바탕으로 실제 예매 봇을 구현했다.
...
| claude-skills | `177afd4` | fix(rail-booking-sniff): Mac IP 검출 개선 (#25) |
| claude-skills | `b58f54e` | feat(submit-app): ASC credentials 헬퍼 (#26) |
| claude-skills | `7b6e42b` | feat(rail-booking-sniff): 고속철도 예매 자동화 v1 |

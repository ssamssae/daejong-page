...
- **철도 예매 자동화 v3**: playwright-stealth + rail_booking_monitor.py 커밋 (`dd115cf`).
...
| automations | dd115cf | feat(rail-booking): rail_booking_bot.py v3 (playwright-stealth) |

...
- index.html L355 [메모요](https://play.google.com/store/apps/details?id=com.daejongkang.simple_memo_app) `app-status` "개인 사용" (어제 production 라이브 후 stale 의심 vs 의도 포지셔닝)

...
> 5노드 sync 인프라 매듭 + [메모요](https://play.google.com/store/apps/details?id=com.daejongkang.simple_memo_app) ([App Store](https://apps.apple.com/kr/app/id6762068073)) Drive 백업 작동 증거 확보 + 강대종 손0 원칙 신설.
...
mac-mini 에 adb 미설치 사실 발견 (Android 빌드 엔진인데 platform-tools 누락 갭) → `brew install --cask android-platform-tools` 박음 (37.0.0). Galaxy S24 (SM_S921N, 내 구글 계정) USB detect PASS. 폰의 Google 계정이 Test users 등록된 계정과 일치라 Drive 권한 동의 시트 흐름은 그대로 검증 가능.

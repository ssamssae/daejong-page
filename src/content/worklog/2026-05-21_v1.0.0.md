...
- 그 세션은 디렉티브 paste 때 따옴표 미종료로 zsh `bquote>` quote-continuation 프롬프트에 박제 → ~5시간 idle. 이게 Clawd 의 "4시간 전" stale 행이자, [메모요](https://play.google.com/store/apps/details?id=com.daejongkang.simple_memo_app) ([App Store](https://apps.apple.com/kr/app/id6762068073)) #14 머지가 안 끝난 진짜 이유(firefight 로 밀린 게 아니었음).
